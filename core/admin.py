...
class ExternalDocumentResource(resources.ModelResource):
    ...
    class Meta:
        model = Document
        fields = ('institution__type__name', 'institution__name', 'category__name', 'type__name', 'title', 'year', 'publisher', 'note', 'url')
        export_order = ('institution__type__name', 'institution__name', 'category__name', 'type__name', 'title', 'year', 'publisher', 'note', 'url')
